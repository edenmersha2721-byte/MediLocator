package com.medicinelocator.search.infrastructure.security;
    ...
    public CurrentUser extract(HttpServletRequest request) {
        ...
        if (userIdStr == null || userIdStr.isBlank()) {
            throw new InvalidSearchRequestException(
                    "Missing X-User-Id header. All requests must pass through the API Gateway.");
        }
        ...
        try {
            ...
            throw new InvalidSearchRequestException("Invalid identity header received from gateway");
        }
    }
}